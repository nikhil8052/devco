export const skills = [
    ...
    },
    {
        ...
        benefits: {
            ...
            description: "SolidWorks is considered one of the premier CAD packages in the world. It has a massive user base, hundreds of thousands of loyal, lifetime customers, and a backend system that makes it easy to design, engineer, and innovate with ease. Some of the specific benefits include:",
            benefits: [
                {
    ...
    },
    {
        ...
        Benefitslider: {
            ...
            description: `Dev.co offers world-class React development services. Our team of experienced React developers are well-versed in the intricacies of the platform and will work with you to produce an application that benefits your end-users. Here’s what our React developer process looks like:`,
            card_datas: [
                {
                    title: "Discovery",
    ...
    },
    {
        ...
        benefits: {
            ...
            description: "Azure makes deploying a diverse array of solutions across a variety of languages a breeze. Whether it’s PHP, Java, .Net, Python, or Node.js, Azure is fully equipped to offer these platforms as a service so they can easily scale to meet any demand at a cost-effective price point (when compared to traditional hosting). Benefits of using Azure include:",
            benefits: [
                {
                    title: "Flexible",
    ...
    },
    {
        ...
        benefits: {
            ...
            description: "With so many free CMS options out there, why would anyone go with an expensive option like Sitefinity? Well, if we’re being honest, people like it because it puts most other CMS platforms to shame. Companies like Coca-Cola and Mercedes Benz use Sitefinity to power their websites – and for good reason. Here are some of the benefits you get when you develop a website using this industry-leading CMS:",
            benefits: [
                {
    ...
    },
    {
        ...
        benefits: {
            ...
            benefits: [
                ...
                {
                    title: "Open source",
                    description: "Part of the reason Android is so popular is that it has an open source platform that makes it easy and inexpensive to get started. And with more people using it on the developer side of things, the result is a smoother and more efficient platform that benefits all third party users.<br>The open source nature of Google Android has led to its massive success. There are now millions of applications available for Android, and many of them are free. This wide selection of applications is one of the main reasons why Android is so popular.<br>Open source software has many benefits. It allows developers to learn from each other, it encourages collaboration, and it helps to keep the software stable and secure. The open source nature of Google Android has helped to make it the most popular mobile operating system in the world.",
                    imageSrc: "/images/rotation_mug.svg",
                    imageHeight: 25,
                    imageWidth: 25,
                },
                ...
                },
                {
                    ...
                    description: "One of the best things about Android is that it is so simple to integrate. Because Android is based on the Linux kernel, it is very easy to port applications from Linux to Android. This allows developers to reuse code from their existing applications, which can save time and money.<br>Android also supports a wide variety of programming languages. This allows developers to use their favorite programming language when creating applications for Android. The most popular programming languages for Android are Java, C++, and Python.<br>Android also supports a variety of different development frameworks. This allows developers to use the development framework that they are most comfortable with. Some of the most popular development frameworks for Android are React Native, Ionic, and Xamarin.<br>Because the Android platform is so customizable, it’s easy to integrate and tweak mobile apps according to very specific business needs",
                    imageSrc: "/images/rotation_mug.svg",
                    imageHeight: 25,
                    imageWidth: 25,
                },
                {
                    title: "Easy approval",
                    description: "With Android, you don’t have to worry about any of the stringent approval processes that other platforms require in order to take an app to market. This speeds up the development cycle and allows you to go from concept to product in a fraction of the time.<br>However, the Android app approval process can sometimes be a challenging one for developers. In order to get an Android app approved in the Google Play Store, you must first create a Google Play Developer account. This account costs $25 per year, and there is also a $100 one-time fee for publishing your application.<br>Once you have created a Google Play Developer account, you must submit your application for review. Your application will be reviewed by Google's team of reviewers, and they will determine whether or not it is approved for publication.<br>The review process can be difficult and time consuming. Google's team of reviewers will check your application for compliance with their guidelines, and they may ask you to make changes to your application before it is approved. If your application does not comply with Google's guidelines, then it may be rejected.<br>The good news is that Google has recently made the review process easier for developers. They have introduced a new program called Developer Preview, which allows developers to release their applications without waiting for approval from Google's team of reviewers. This program is still in beta, so it may have some bugs, but it is a great way to test your application before submitting it for review.",
                    imageSrc: "/images/rotation_mug.svg",
                    imageHeight: 25,
                    imageWidth: 25,
                },
