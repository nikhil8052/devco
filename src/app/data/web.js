  ...
  faqs: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, we do have case studies and examples of previous work. We can provide you with a list of references from past clients as well. Examples are available here from our work portfolio.",
      },
      {
        question:
          "How involved will I be in the design and development process?",
        answer:
          "As the client you can be involved in the design process as much as you feel comfortable. DEV.co will keep you updated on the progress of the project and should welcome any feedback or input throughout the web development process.",
      },
      {
        question:
          "What is your process for designing and building a custom website or web app?",
        answer:
      ...
      },
      {
        ...
        answer:
          "We are always looking for top talent in the web development industry. If you are looking to become a web developer, we encourage you to look at our job board for in-house openings or get in touch with one of our technology recruiters for open staff positions with one of our partner companies. Most web developers and web designers are not a fit for our team. We have a stringent process for hiring other web developers. Get in touch with us regarding any open software developer roles we have.",
      },
      {
        question: "Can you please provide a list of references?",
        answer:
          "Feel free to view our portfolio/work page or reach out to us and we can provide a direct list of references to get you comfortable with the quality of our work and the experience of our web dev team.",
      },
      {
        question: "Will you host my site or do I need to host it?",
        answer:
          "We offer a variety of hosting options that fit your needs. You can bring your own host or let us host your site for you. In addition, we offer managed hosting plans that include things like regular site speed enhancements.",
      },
      {
