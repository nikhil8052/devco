...
export default function ClientCount() {
  return (
    ...
    <div className='clint_count_section py-20' style={{
      ...
      <div className="section_head grid xl:grid-cols-2 md:grid-cols-1 xl:gap-20 md:gap-10 lg:mb-20 md:mb-10 mb-5"> 
          ...
          <div className='right_text_col'>
            <p className='2xl:text-[24px] xl:text-[18px] md:text[14px] sm:text[14px] text[14px] font-normal text-customwhite'>Our custom dev services are trusted software companies, small businesses and Fortune 500 companies alike </p>
          </div>
        </div>
