    ...
    <div className="hero_CenterAnimatedtext relative w-full py-[10px]">
      <div className="container mx-auto relative z-10">
        <div className="full_wrap bg_logo_div relative py-[100px]">
          ...
          <div
            ref={textRef}
            className="animated_text_wrap text-center w-full max-w-[790px] mx-auto relative z-10 opacity-0"
          >
            <h2 className="text-[34px] 2xl:text-[70px] xl:text-[45px] md:text-[36px] sm:text-[34px] font-semibold text-white">
            Ready to launch a stellar user experience?
            </h2>
            <div className="mt-5 paradiv text-[14px] xl:text-[22px] lg:text-[20px] md:text-[15px] sm:text-[14px] font-normal text-customwhite text-opacity-70">
              ...
              We want to partner with you to create a user experience your visitors will love. Contact us to discuss your project with a Dev.co UX/UI expert and let us help make your digital project a success.
              </p>
            </div>
...
export default Centeranimtetextbottom;
