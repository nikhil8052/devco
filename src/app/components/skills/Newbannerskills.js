...
const Newbannerskills = ({ subtitle = "", title = "", description = "", bannericon = "" }) => {
  return (
    <div className="hero_banner new_banner skills_page_banner servicepage_banner relative w-full pt-20">
...
export default Newbannerskills;
