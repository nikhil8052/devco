...
export default function Benefit() {
  return (
    <div className="benefit-container p-4 md:p-8 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
      {/* Image Section */}
      <div className="flex-shrink-0">
        <Image src="/images/rotation_mug.svg" width={30} height={30} alt="Benefit Icon" />
      </div>

      {/* Text Section */}
      <div className="text-section text-center md:text-left">
        <h4 className="text-xl md:text-2xl font-semibold mb-2">Save time</h4>
