...
export default function Checkimgcard({imageWidth, imageHeight }) {
  return (
    ...
    <div className="checkimgcard-sec py-10 md:py-20">
        ...
        <div className="checkimgcard-container grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-10">
            <div className="w-full max-w-[590px] rounded overflow-hidden shadow-lg border-lightBlue border p-5 data_card bg-white/4 backdrop-blur-lg">
