  ...
  return (
    <div className='new_section benefits_section border-sectionmain'>
      <div className='container'>
        <div className="benefits-container grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 md:gap-y-10 rounded overflow-hidden shadow-lg border-lightBlue border p-5 lg:p-8 md:p-6 h-full">
