        ...
        <div className='service_cards_wrapper relative z-10'>
          <div className='container mx-auto'>
            <div className='card_col_flex flex w-full gap-y-10'>
              ...
              <div className='left_side lg:pb-20 md:pb-5 min-w-[65%] relative z-10'>
                <div className="grid-head w-full">
                  ...
                  <div className='w-full max-w-[590px]'>
                    <p className='section_head_para 2xl:text-[22px] xl:text-[18px] md:text[14px] sm:text[14px]  font-normal text-customwhite'>{description}</p>
                  </div>
                </div>
                <div className='animated_frame_wrap my-5 2xl:hidden xl:hidden md:block sm:block'>
                <Image
              ...
              <div className='animated_frame_wrap lg-mr-[-4rem] md:mr-[0px] sticky top-[50px] self-start md:hidden lg:block show_desktop  '>
                <Image
                  className='service_frame w-full xl:scale-[1.3] lg:scale-[1.3] md:scale-[1] origin-top-right lg:max-w-[800px]'
                  src={sideImage}
                  alt="Banner Image"
                  width={879}
                  height={500}
