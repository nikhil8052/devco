...
<<<<<<< HEAD
          ...
          <p className="text-[24px] font-normal text-customwhite">
            {description}
=======
          <h2 className="lg:text-[22px] md:text-[18px] sm:text-[18px] text-customwhite font-semibold">
            Web Development & Software Engineering
          </h2>
          <p className="lg:text-[24px] md:text-[18px] sm:text-[14px] font-normal text-customwhite">
