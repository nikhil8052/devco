        ...
        <div className="full_wrap bg_logo_div relative py-[100px]">
          ...
          >
            ...
            <div className="mt-5 paradiv text-[14px] xl:text-[22px] lg:text-[20px] md:text-[15px] sm:text-[14px] font-normal text-customwhite text-opacity-70">
              ...
              Contact us today to learn more about how our web developer services can make your business more profitable Or, if you’re one of many experienced, but aspiring professional web developers that is well beyond just learning programming languages or you already know multiple coding languages and are looking for a new career path, get in touch! As one of the best web development companies on the market, there is likely a fit for your dev services and abilities.
              </p>
            </div>
